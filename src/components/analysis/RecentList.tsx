...
export function AnalysisRecentList({ records, onSelect }: { records: ExperienceRecord[]; onSelect: (id: string) => void }) {
  ...
  return (
    <div>
      ...
      <div className="mb-4 grid grid-cols-4 gap-2.5 max-[900px]:grid-cols-2 max-[600px]:grid-cols-1">
